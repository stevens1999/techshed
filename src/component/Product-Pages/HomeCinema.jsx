...
// Filter products for Home Cinema category (TVs and Projectors)
const homeCinemaProducts = Products.filter(
  (product) => product.category === "TVs" || product.category === "Projectors"
);
...
const HomeCinema = () => {
  const [allProducts] = useState(homeCinemaProducts);
