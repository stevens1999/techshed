...
// Filter products for Tablets category
const tabletProducts = Products.filter(product => 
...
const Tablets = () => {
  const [allProducts] = useState(tabletProducts);
  ...
  const handleSeeMore = () => {
    setVisibleProductCount((prevCount) =>
      Math.min(prevCount + productsPerLoad, displayedProducts.length)
    );
  };

  // Handler to show fewer products
  const handleSeeLess = () => {
    setVisibleProductCount(initialDisplayCount);
  };
        ...
        <div className="lg:flex">
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            >
                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-2 pl-2">
                    {[
                      ...
                      { name: "Drones & Camera", path: "/Drones" },
              ...
              <div className="mt-4">
                <h3 className="font-bold text-lg mb-3 flex items-center">
                  <FontAwesomeIcon icon={faSort} className="mr-2 text-blue-600"/>
                  Sort by
                </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-5 gap-x-6 gap-y-8">
            {displayedProducts.slice(0, visibleProductCount).map((product) => (
              <Link to={`/product/${product.id}`} key={product.id} className="hover:scale-105 transition-transform duration-300">
