...
const ShopAll = () => {
  ...
  if (loading) {
    return (
      <div className="mt-40 lg:mt-47">
        <div className="min-h-screen antialiased p-4 sm:p-6 lg:p-8 flex justify-center items-center">
  ...
  if (error) {
    return (
      <div className="mt-40 lg:mt-47 lg:mx-10">
        <div className="min-h-screen antialiased p-4 sm:p-6 lg:p-8 flex justify-center items-center">
  ...
  return (
    <div className="mt-40 lg:mt-47 lg:mx-10">
      <div className="min-h-screen antialiased p-4 sm:p-6 lg:p-8 md:flex md:flex-col">
        {/* Header Section */}
