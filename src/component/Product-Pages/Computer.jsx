...
// Filter products for Computer category (Laptops and Desktops)
const computerProducts = Products.filter(
  (product) => product.category === "Laptops" || product.category === "Desktops"
);
...
const Computer = () => {
  const [allProducts] = useState(computerProducts);
